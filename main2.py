...
params = types.SimpleNamespace(
    ...
    dim = 64, # originally 1024, embedding dimension, a.k.a. hidden dimension of attention, latent space dimension, etc. (Increased from 64)
    x_num = 128,
    ...
    dim_feedforward=64, # 275, originally (Increased from 64)
    max_len=128,
...
# ==================================
# Below is to load the parameters from .pt file.
# ==================================
...
plt.legend()
plt.grid(True)
plt.savefig('training_validation_loss_plot.pdf') # Add this line to save the plot
